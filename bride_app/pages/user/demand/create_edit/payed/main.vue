<template>
	<view>
		...
		<div v-if="data.show">
			<block v-if="data.detail.status == 3">
				<dx-results txt="发布成功，信息审核中！" @click="goto('/pages/index/main',2)" gotxt="返回"></dx-results>
			</block>
			<block v-else>
				<dx-results txt="发布失败" :success="false" @click="goto('/pages/index/main',2)" gotxt="返回"></dx-results>
			</block>
