<template>
	<section class="cash-box clearfix" v-if="data.show">
		<div class="cash-left">
					...
					<div class="row_group">
						<div class="row_item">
							...
							<div class="searchInput value pl5">
								<searchClient @callback="searchClientCallBack" ref="searchMember" myclass="cl-search"></searchClient>
							</div>
						</div>
						<div class="row_item">
					...
					<div class="package_div">
						<div class="head-table">
							<table class="">
								<thead>
									<tr>
										<th width="45%" align="center">套餐项目</th>
										<th width="15%" align="center">套餐次数</th>
			...
			<div class="searchInfo">
				<ul class="cash-nav product_type">
					<li :class="['type0' ,showType == 0 ? 'active' :'']"><a href="javascript:;" @click="showType = 0">项目<span
								class="num_count cart_type0_length">{{ cartData0.length }}</span></a></li>
					<li :class="['type3' ,showType == 2 ? 'active' :'']" @click="showType = 2"><a href="javascript:;">购买套餐<span
								class="num_count cart_type2_length">{{ cartData2.length }}</span></a></li>
					<li :class="['type3' ,showType == 3 ? 'active' :'']"><a href="javascript:;" @click="showType = 3">套餐结算<span
				...
				<ul class="flex flex-between" @mouseleave="productFclassDiag=false;zclassData=[]">
					<div class="nav-tab-item pull-left">
						...
						<li :class="['cash-nav-tabs' , showTypeDiv ==2 ? 'active' :'']">
							<a href="javascript:;" @mouseover="showPclassDig=false;showP1classDig=false;showTypeDiv=2">套餐项目</a>
						</li>
					</div>
		...
		<payConfirm :amount="total" :clientInfo="clientInfo" ref="pay_confirm" :category="data.category" @callBack="payCallBack"  :brand="data.brand" :cartData0="cartData0" :cartData3="cartData3"></payConfirm>
