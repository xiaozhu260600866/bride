<template>
	<section>
		<div class="Tsearch">
		 ...
		 <el-col :span="24">
			<el-tabs v-model="type" type="card" @tab-click="clickStatus">
				<el-tab-pane label="首页广告位" :name="''+1000"></el-tab-pane>
				<el-tab-pane label="首页广告位2" :name="''+1001"></el-tab-pane>
				<el-tab-pane label="首页广告位3" :name="''+1002"></el-tab-pane>
				 <el-tab-pane label="首面弹框广告位" :name="''+1109"></el-tab-pane>
				 <el-tab-pane label="会员中心弹框广告位" :name="''+1110"></el-tab-pane>
				<el-tab-pane label="需求广告位" :name="''+1004"></el-tab-pane>
				<el-tab-pane label="需求导航" :name="''+1007"></el-tab-pane>
				<el-tab-pane label="商城广告位" :name="''+1006"></el-tab-pane>
				<!-- <el-tab-pane label="现金券点广告位" :name="''+1005"></el-tab-pane>
				<el-tab-pane label="商家商城轮播图" :name="''+1107"></el-tab-pane>
				<el-tab-pane label="商家商城导航图" :name="''+1108"></el-tab-pane>
				<el-tab-pane label="券优惠轮播图" :name="''+9109"></el-tab-pane>
				<el-tab-pane label="券优惠导航图" :name="''+9110"></el-tab-pane> -->
			</el-tabs>
		</el-col>
		<el-table ref="multipleTable" :data="data.lists" border tooltip-effect="dark" style="width: 100%" @selection-change="selsChange" v-loading="data.listLoading">
			...
			<el-table-column align="center" label="隐藏/显示" width="90">
