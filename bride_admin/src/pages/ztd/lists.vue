	...
	<section>
		<div class="Tsearch">
			<el-form :inline="true" :model="searchFields">
				...
				<div class="Tlnav-po">
					<el-button type="primary" @click="$refs.createEdit.ajax('',data.industryArr,data.roleArr)">新增</el-button>
				</div>
			</el-form>
		</div>
		<el-table ref="multipleTable" :data="data.lists" border tooltip-effect="dark" style="width: 100%" @selection-change="selsChange" v-loading="data.listLoading">
			...
			<el-table-column label="序号" width="60">
			  ...
			  <el-table-column label="自提点名称" min-width="150">
			...
			<el-table-column prop="merchant_amount" label="金额" width="120"> </el-table-column>
				...
				<template scope="scope">
					<el-dropdown>
						...
						<el-dropdown-menu slot="dropdown">
							<el-dropdown-item @click.native="$refs.createEdit.ajax(scope.row,data.industryArr,data.roleArr)">编辑</el-dropdown-item>
