    ...
    export default {
        ...
        methods: {
            toDown(row) {
               ...
               lev += 1
              //window.open('http://localhost:456/#/vueadmin/system/city?fid=' + row.id + '&lev=' + lev)
              window.open('https://456.doxinsoft.com/templateadmin/#/vueadmin/system/city?fid=' + row.id + '&lev=' + lev)
            },
