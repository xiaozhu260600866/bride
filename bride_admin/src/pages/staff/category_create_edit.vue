<template>
	<el-dialog title="新建\编辑" :visible.sync="dialogFormVisible" width="800px" :top="top" :before-close="handleClose">
		<el-form :model="ruleForm" ref="ruleForm" label-width="100px" class="demo-ruleForm">
			<el-form-item label="水店名称" prop="company_name" :rules="[{ required: true, message: '姓名不能为空'},]">
			...
			<div class="group-item flex">
				...
				<el-form-item label="电话" prop="username" :rules="[{ required: true, message: '电话不能为空'}]">
		...
		ajax: function(params, merchantLists, departmentArr,area,roleArr,waterShops) {
			...
			this.$nextTick(()=>{
				...
				if (params) {
					...
					this.$set(this.ruleForm,"water_name","")
					this.$set(this.ruleForm,"is_children","")
                    this.ruleForm.city = params.city;
					if(this.ruleForm.water_name  == '四海通'){
						this.ruleForm.water_name = "";
					}else{
						this.ruleForm.water_name = params.water_name;
					}
					...
					this.ruleForm = { role_id: '', sort: 0, status: 0, gender: '',water_name:'' };
