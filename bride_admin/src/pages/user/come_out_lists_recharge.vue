<template>
	<section>
		...
		<el-table ref="multipleTable" :data="data.lists" border tooltip-effect="dark" style="width: 100%" @selection-change="selsChange" v-loading="data.listLoading">
			...
			<el-table-column prop="getStatus" label="状态" min-width="100"> </el-table-column>
			<el-table-column prop="amount" label="充值金额" min-width="100"> </el-table-column>
...
export default {
	data() {
		return {
			formAction: '/admin/user/come-out-lists?type=0&adminSource=充值',
