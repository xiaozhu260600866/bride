<template>
	<section>
		<div class="Tsearch">
			<el-form :inline="true" :model="searchFields">
				...
				<div class="Tsec_group Tlnav">
					...
					<el-button type="success" @click="putawayAll">批量上架</el-button>
				</div>
				<div class="Tlnav-po">
		...
		<el-col :span="24">
			<el-tabs v-model="data.query.show_index2" type="card" @tab-click="ajax">
		...
		<!-- 	<el-table-column align="center" label="是否自提" width="80">
			...
			<el-table-column align="center" label="上架" width="80">
				<template scope="scope">
		...
		<el-col :span="24" class="toolbar mtb20">
			<el-button type="danger" @click="showIndexAll()" :disabled="this.sels.length===0 ">批量上架</el-button>
...
export default {
	data() {
		return {
			formAction: '/admin/merchant/lists?status=1',
	...
	methods: {
		putawayAll(){
			this.getConfirm("是否批量上架",msg=>{
			    this.postAjax("/admin/merchant/editField", { type:'allRows',field:"show_index2",value:1 }, msg => {
