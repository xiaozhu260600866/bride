...
<script type="text/javascript">
    export default {
        data() {
            return {
                formAction: '/admin/alliance/lists',
        ...
        methods: {
            ...
            editField(row, field) {
                this.postAjax("/admin/alliance/editField", {
                    id: row.id,
                    field: field,
                    value: row[field]
                }, msg => {
            ...
            exportExcel() {
                window.location.href = this.siteName + "admin/alliance/export?api_token=" + this.getUser().api_token;
            },
