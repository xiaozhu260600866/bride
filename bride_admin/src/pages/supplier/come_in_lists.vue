			...
			<el-form :inline="true" :model="data.query">
				<div class="Tsec_group">
					<el-form-item label="订单号：">
						<el-input v-model="data.query.order_no" placeholder="请输入订单号"></el-input>
					</el-form-item>
					<el-form-item label="供货商：">
						<el-input v-model="data.query.company_name" placeholder="请输入供货商名称"></el-input>
					</el-form-item>
...
export default {
	data() {
		return {
			formAction: '/admin/supplier/come-out-lists?type=0',
	...
	methods: {
		exportExcel(){
			let url = this.urlApendOpenid("/admin/supplier/export-comission?type=0&status=1", this);
