<template>
	<el-dialog title="新建\编辑" :visible.sync="dialogFormVisible" width="800px" :top="top" :before-close="handleClose">
		<el-form :model="ruleForm" ref="ruleForm" label-width="100px" class="demo-ruleForm">
            ...
            <el-form-item label="等级" prop="manager_lev_id" :rules="[{ required: true, message: '等级不能为空'}]">
            	<el-select v-model="ruleForm.manager_lev_id" placeholder="请选择">
            	    <el-option v-for="item in lev" :label="item.label" :value="item.value">
            	    </el-option>
            	</el-select>
            </el-form-item>
...
import chooseLocation from "xiaozhu/vue/components/admin/chooseLocation";
	...
	methods: {
		...
		ajax: function(params,lev,city) {
			this.$nextTick(()=>{
				this.dialogFormVisible = true;
				this.lev = lev;
                this.city = city;
				if (params) {
					this.formAction = '/admin/manager/edit?id=' + params.id;
					this.ruleForm = params;
					this.ruleForm.sex = parseInt(this.ruleForm.sex);
					this.ruleForm.username = params.getUser.username;
                    this.ruleForm.manager_lev_id = params.manager_lev_id;
					...
					this.ruleForm = { manager_lev_id: '' };
					this.formAction = '/admin/manager/create';
				}
