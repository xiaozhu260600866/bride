<template>
	<section>
			...
			<el-form :inline="true" :model="data.query">
				...
				<div class="Tsec_group">
					...
					<el-form-item label="供应商：">
						<el-select v-model="data.query.take_supplier_user_id" placeholder="请选择供应商" v-if="getUser().role == 1">
		...
		<el-table ref="multipleTable" :data="data.lists" border tooltip-effect="dark" style="width: 100%"
			...
			<el-table-column prop="take_supplier_user_id" align="center" label="供应商id" width="65"> </el-table-column>
